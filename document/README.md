...
| [16-模块远程下载与发布流程](./development/16-模块远程下载与发布流程.md) | 模块从同 repo Release 远程更新：资产命名、上传顺序与留存、清单信任锚（不走代理）、24h 缓存/ETag、代理信任规则、`requireSignature` 状态与 Phase 2 迁移、精简包（slim）构建变体与取舍、已知风险 |
